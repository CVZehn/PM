...
#define OLED_SCLK_Clr() LL_GPIO_ResetOutputPin(GPIOA, OLED_SCL_Pin)//SCL
#define OLED_SCLK_Set() LL_GPIO_SetOutputPin(GPIOA, OLED_SCL_Pin)

#define OLED_SDIN_Clr() LL_GPIO_ResetOutputPin(GPIOA, OLED_SDA_Pin)
#define OLED_SDIN_Set() LL_GPIO_SetOutputPin(GPIOA, OLED_SDA_Pin)
